...
// TestRouterLLM_ReassessUsesRouter was removed in M6 G2 alongside the
// reassessIntent helper and the explorer sub-agent. There is no longer an
// "explorer pass + reassess pass" route through the router — the unified
// Primary Assistant covers exploration directly.

// sequentialTaggingCompleter was the multi-response mock for
// TestRouterLLM_ReassessUsesRouter; deleted alongside that test in M6 G2.
