...
术语见 [../../../glossary.md](../../../glossary.md);run mode 枚举见 [dictionary-run-mode](../../../../vv-prd/dictionaries/core/dictionary-run-mode.md)。
...
子系统开关及其默认状态、依赖关系见 [design.md](design.md)「可选子系统挂载策略」。完整字段清单引用 [model-configuration](../../../../vv-prd/models/core/config/model-configuration.md)。
...
完整启动业务规则(STARTUP-*/DEBUG-*/PERM-*)见 [procedure-application-startup](../../../../vv-prd/procedures/core/config/procedure-application-startup.md)。
