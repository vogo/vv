...
各领域 `spec.md` / `design.md` 写高层行为与取舍;细粒度制品(模型字段、流程逐步、HTTP 页签、字典枚举)引用 `vv-prd/` 对应路径:

| specs 领域 | vv-prd 对照 |
|-----------|------------|
| configuration | `models/core/config/`、`procedures/core/config/` |
| tools | `models/core/tools/`、`dictionaries/core/dictionary-bash-risk-tier.md` 等 |
| agents | `models/core/agents/`、`architecture/roles.md` |
| orchestration | `models/core/planner/`、`procedures/core/{orchestration,planner,routing,agent-execution}/` |
| memory | `models/core/memory/`、`procedures/core/memory/` |
| session | `models/core/session/`、`models/core/workspace/` |
| cli | `models/core/cli/`、`procedures/core/cli/`、`applications/cli/` |
| http-api | `models/core/server/`、`applications/api/` |
| mcp | `applications/mcp/` |
| cost-tracking | `models/core/costtracker/` |
| budget | `models/core/budget/`、`procedures/core/budget/` |
| trace | `models/core/trace/`、`procedures/core/trace/` |
| eval | `procedures/core/eval/`、`dictionaries/core/dictionary-evaluator-name.md` |
