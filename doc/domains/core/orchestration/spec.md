...
> 规则刻意只保留 **不变量与边界**。逐步流程(哪轮选哪个动作、DAG 如何调度并行)由代码与 `vv-prd/procedures/` 承载,不在此复述。

## States & transitions

Task Plan 与 Plan Step 的状态枚举为权威值,完整定义见 [../../../../vv-prd/dictionaries/core/dictionary-plan-status.md](../../../../vv-prd/dictionaries/core/dictionary-plan-status.md) 与 [dictionary-plan-step-status.md](../../../../vv-prd/dictionaries/core/dictionary-plan-step-status.md);转移触发与后置动作见 [models.md](models.md) 及 [../../../../vv-prd/models/core/planner/](../../../../vv-prd/models/core/planner/)。
